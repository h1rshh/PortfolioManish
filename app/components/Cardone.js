...
const Cardone = () => {
  return (
    <div className="flex justify-center items-center bg-gray-100 font-sans pt-4 md:pt-10">
      <div className="bg-gradient-to-r from-[#D2B48C] to-[#b69c70] text-white rounded-lg shadow-lg py-1 sm:py-2 md:py-2 px-2 sm:px-4 md:px-6 max-w-[90%] md:max-w-[80%] lg:max-w-[60%] w-full mx-auto">
        ...
        <div className="flex justify-center">
          <button className="bg-white text-[#c79847] font-semibold py-1 px-3 rounded transition-transform transform hover:scale-105 hover:shadow-lg">
            Earn Now
          </button>
        </div>
      </div>
